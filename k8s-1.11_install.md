...
[官网地址：](https://kubernetes.io/docs/setup/independent/create-cluster-kubeadm/)https://kubernetes.io/docs/setup/independent/create-cluster-kubeadm
